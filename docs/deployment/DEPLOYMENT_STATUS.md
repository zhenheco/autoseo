...
LEGACY_PAYMENT_PROVIDER_REMOVED=your_merchant_id
LEGACY_PAYMENT_PROVIDER_REMOVED=your_hash_key
LEGACY_PAYMENT_PROVIDER_REMOVED=your_hash_iv
...
### 步驟 4: 更新 legacy payment provider (removed 2026-05-21) Webhook

登入 legacy payment provider (removed 2026-05-21) 後台，更新回調 URL：
...
5. **支援外部 Webhook** - legacy payment provider (removed 2026-05-21) 付款回調正常運作
...
- [x] 設定 Cloudflare DNS
- [ ] 等待 SSL 憑證生成（進行中）
- [ ] 更新 legacy payment provider (removed 2026-05-21) webhook URL
