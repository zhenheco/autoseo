...
## 自訂網域（解決 legacy payment provider (removed 2026-05-21) 回調問題）

### 為什麼需要自訂網域？

**Cloudflare Tunnel 的限制**：

- ❌ 無法接收外部服務的 webhook（如 legacy payment provider (removed 2026-05-21) 回調）
- ❌ 出現 Error 1033：外部服務無法主動連接

**Cloudflare Workers + 自訂網域的優勢**：

- ✅ 公開可訪問的 URL，legacy payment provider (removed 2026-05-21) 可以直接發送回調
- ✅ 自動 SSL 證書
- ✅ 全球 300+ 邊緣節點
- ✅ DDoS 保護
...
### 更新 legacy payment provider (removed 2026-05-21) 設定

登入 legacy payment provider (removed 2026-05-21) 管理後台，更新回調 URL：
