...
5. `LEGACY_PAYMENT_PROVIDER_REMOVED.md` - Webhook 更新指引
...
1. ✅ 完成 legacy payment provider (removed 2026-05-21) webhook 更新
...
1. 更新 legacy payment provider (removed 2026-05-21) webhook 設定
2. 使用瀏覽器進行完整功能測試
3. 監控網站運行狀況
4. 根據需求進行進一步優化
