    ...
    Tables: {
      ...
      recurring_mandates: {
        Row: {
          ...
          periods_paid: number
          status: 'pending' | 'active' | 'suspended' | 'terminated' | 'completed' | 'failed'
          newebpay_response: Json | null
      ...
      companies: {
        Row: {
          ...
          slug: string
          owner_id: string
          subscription_tier: 'free' | 'starter' | 'professional' | 'business' | 'agency'
      ...
      token_usage_logs: {
        Row: {
          ...
          usage_type: 'article_generation' | 'title_generation' | 'image_description' | 'perplexity_analysis'
          metadata: Json
          created_at: string
        }
        Insert: {
