...
export function TokenBalanceCard() {
  ...
  return (
    <div className={cn(
      ...
      isCritical ? "border-red-500/50 hover:border-red-500/70" : isLowBalance ? "border-orange-500/50 hover:border-orange-500/70" : "border-border/50 hover:border-primary/50"
    )}>
      <div className="flex items-start justify-between">
        <div className="flex-1">
          ...
          <p className={cn(
            ...
            isCritical ? "text-red-600" : isLowBalance ? "text-orange-600" : "text-foreground group-hover:text-primary"
          )}>
