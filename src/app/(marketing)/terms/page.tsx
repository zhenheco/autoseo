      ...
      <div className="container relative z-10 mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="glass border-white/10 rounded-2xl p-8 shadow-xl backdrop-blur-xl">
          <div className="flex items-center gap-3 mb-6">
            <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-cyber-cyan-500 to-cyber-magenta-500 flex items-center justify-center shadow-lg shadow-cyber-cyan-500/30">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold mb-3 mt-6 text-slate-200">
                2.1 服務內容
              </h3>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-300 mb-3">服務使用限制：</p>
              <ul className="list-disc pl-6 text-slate-300 space-y-2">
              ...
              <p className="text-slate-300 mb-3 mt-4">本公司保留權利：</p>
              <ul className="list-disc pl-6 text-slate-300 space-y-2">
                <li>進行系統維護和更新。</li>
                <li>暫停或終止違反條款的帳號。</li>
                <li>修改或終止服務功能。</li>
              ...
              <p className="text-slate-300 mb-3 mt-4">1WaySEO：</p>
              <ul className="list-disc pl-6 text-slate-300 space-y-2">
                <li>不保證服務無中斷或無錯誤。</li>
                <li>不對間接損失負責。</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-300">如對服務條款有任何疑問，請聯絡：</p>
