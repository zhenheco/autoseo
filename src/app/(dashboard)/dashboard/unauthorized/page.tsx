        ...
        <Card className="max-w-2xl w-full border-primary/20">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="p-6 rounded-lg bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20">
              <h3 className="font-semibold text-lg mb-4">升級至 STARTER 方案即可享有：</h3>
              ...
              <div className="flex items-baseline gap-2 mb-4">
                ...
                <span className="text-xs text-muted-foreground ml-2">年繳享 83 折</span>
              </div>
            ...
            <p className="text-xs text-center text-muted-foreground">
              有任何問題？<Link href="/contact" className="text-primary hover:underline">聯絡我們</Link>
            </p>
          </CardContent>
        </Card>
      </div>
