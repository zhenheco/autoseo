...
import { ArrowRight, CheckCircle2, Globe, Key, FileText, Sparkles } from 'lucide-react'
...
const steps = [
  {
    id: 1,
    title: '新增網站',
    description: '連接您的 WordPress 網站到 Auto Pilot SEO',
    icon: Globe,
              ...
              >
                <CardHeader className="pb-4">
                  <div className="flex items-start gap-5">
                    <div className={`relative h-14 w-14 rounded-xl bg-gradient-to-br ${step.color} flex items-center justify-center shrink-0`}>
                      <IconComponent className={`h-7 w-7 ${step.iconColor}`} />
                      <div className="absolute -top-2 -right-2">
                        <Badge variant="secondary" className="h-6 w-6 rounded-full p-0 flex items-center justify-center bg-background border border-border">
        ...
        <div className="mt-8 text-center">
          <Link href="/dashboard">
            <Button variant="ghost" className="group/back">
              <svg className="h-4 w-4 mr-2 group-hover/back:-translate-x-0.5 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
