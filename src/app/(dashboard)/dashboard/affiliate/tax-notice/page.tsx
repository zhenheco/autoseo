        ...
        <CardContent className="space-y-6">
          <div>
            ...
            <p className="text-gray-700">
              聯盟行銷佣金屬於「<strong>其他所得</strong>」（所得稅法第 14 條第 1 項第 10 類），需併入個人綜合所得稅申報。
            </p>
          </div>

          <div>
            <h3 className="font-semibold text-lg mb-3">2. 扣繳義務</h3>
            <p className="text-gray-700 mb-4">根據「各類所得扣繳率標準」規定：</p>

            <div className="space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                <h4 className="font-semibold mb-2 text-blue-900">📌 境內居住者（台灣居民）</h4>
                <ul className="space-y-2 text-gray-700">
                  <li>
                    <strong>年度累計佣金 ≤ NT$20,000</strong>：免扣繳，但仍需申報所得
                  </li>
                  <li>
                    <strong>年度累計佣金 {'>'} NT$20,000</strong>：扣繳稅率 <strong className="text-blue-600">10%</strong>
                  </li>
              ...
              <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                <h4 className="font-semibold mb-2 text-orange-900">📌 非境內居住者（外國人/僑胞）</h4>
                <ul className="space-y-2 text-gray-700">
                  <li>
                    無論金額大小，一律扣繳 <strong className="text-orange-600">20%</strong>
                  </li>
                  <li>需填寫「非居住者身分聲明書」</li>
                </ul>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">年度累計佣金超過 NT$20,000</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          <Alert>
            <AlertCircle className="h-4 w-4" />
            <AlertDescription>
              實際應繳稅額會根據您的<strong>年度總所得</strong>和適用稅率計算，扣繳的 10% 只是預繳，不是最終稅率。
            </AlertDescription>
          </Alert>
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <div className="space-y-2 text-sm text-gray-700">
              <p>
                假設您年度佣金收入為 <strong>NT$100,000</strong>，其他收入為 <strong>NT$500,000</strong>
              </p>
              <ol className="list-decimal list-inside space-y-1 ml-2">
                <li>預扣 10%：NT$100,000 × 10% = NT$10,000</li>
                <li>總所得：NT$600,000（扣除免稅額後假設為 NT$510,000）</li>
                <li>
                  應納稅額：NT$510,000 × 5% = NT$25,500（適用 5% 級距）
                </li>
                <li>
        ...
        <CardContent>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-2">
              ...
              <span>
                請確保提供的<strong>身分證字號/統編</strong>和<strong>銀行帳戶</strong>資料正確無誤
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600 mt-1">•</span>
              <span>
                首次提領前需上傳<strong>身分證明文件</strong>和<strong>銀行存摺影本</strong>
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-600 mt-1">•</span>
              <span>
                提領金額為<strong>扣除稅款後的淨額</strong>（例如：申請提領 NT$10,000，實際入帳
                NT$9,000）
              </span>
            </li>
            <li className="flex items-start gap-2">
