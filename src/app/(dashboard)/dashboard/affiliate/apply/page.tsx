    ...
    <div className="container mx-auto max-w-2xl p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          />
          <p className="mt-1 text-sm text-gray-500">個人：身份證字號，公司：統一編號</p>
        </div>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700">稅務身份</label>
          <div className="mt-2 space-y-2">
            ...
            <label className="flex items-center">
              <input
                type="radio"
                checked={!formData.is_resident}
                onChange={() => setFormData({ ...formData, is_resident: false })}
                className="mr-2"
              />
