...
- **THEN** the system SHALL:
  ...
  - Return form with PostData_ and MerchantID_ fields
...
- **THEN** the system SHALL:
  ...
  - Create input field with name="MerchantID_" value=merchantId
  - Create input field with name="PostData_" value=postData
