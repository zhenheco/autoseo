...
async function testGoogleDrive() {
  console.log('🔍 檢查 Google Drive 配置...\n');
  ...
  requiredVars.forEach((v) => {
    ...
    const display = v.includes('SECRET') || v.includes('TOKEN')
  ...
  try {
    ...
    const uploadResult = await client.uploadImage(imageBuffer, 'test-upload.jpg', 'image/jpeg');
    ...
    console.log('   提示：請確認此資料夾在 Google Drive 中存在且有寫入權限');
