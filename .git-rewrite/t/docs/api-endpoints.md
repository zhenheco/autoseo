...
```json
{
  ...
  "data": {
    ...
    "common_topics": ["Next.js 基礎概念", "Server Components", "路由系統"],
  ...
  "data": {
    ...
    "outline": {
      ...
      "main_sections": [
        {
          "h2": "什麼是 Next.js？",
          "h3": ["Next.js 的歷史與發展", "與其他框架的比較", "核心特性介紹"]
        },
        {
          "h2": "Next.js 安裝與設定",
          "h3": ["環境需求", "建立新專案", "專案結構說明"]
        }
      ],
    ...
    "related_keywords": ["React Server Components", "SSR", "SSG", "App Router"]
  }
}
```
