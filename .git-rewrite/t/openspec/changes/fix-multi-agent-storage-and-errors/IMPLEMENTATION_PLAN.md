...
export class MultiAgentOutputAdapter {
  adapt(input: AdapterInput): WritingAgentOutput {
    ...
    return {
      ...
      keywordUsage: this.analyzeKeywordUsage(assemblerOutput.markdown, focusKeyword),
  ...
  private enhanceStatistics(stats: ContentAssemblerStatistics): ArticleStatistics {
