# Spec: XSS 防護 (Cross-Site Scripting Protection)

## 概述

防止所有形式的 XSS 攻擊,包括反射型、儲存型和 DOM-based XSS。
...
- `security-headers`: Content-Security-Policy 標頭
- `automated-security-checks`: 自動 XSS 掃描
